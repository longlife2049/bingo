...
const BLOG = {
  AUTHOR: '宾果数码', // 作者
  BIO: '宾果供应链', // 作者简介
  LINK: 'www.3hwork.com', // 网站地址
  KEYWORDS: '宾果供应链,华强北,一件代发', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '18666d15d5e94374988e72286ed7c5c4', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '粤ICP备2020140036号-1', // 备案号 闽ICP备XXXXXXX
  ...
  CONTACT_EMAIL: 'admin@3hwork.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: '',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_UTTERRANCES_REPO:
    process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'longlife2049/bingo', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/

  // gitalk评论插件 更多参考 https://gitalk.github.io/
  COMMENT_GITALK_REPO: process.env.NEXT_PUBLIC_COMMENT_GITALK_REPO || 'bingo', // 你的Github仓库名，例如 'NotionNext'
  COMMENT_GITALK_OWNER: process.env.NEXT_PUBLIC_COMMENT_GITALK_OWNER || 'longlife2049', // 你的用户名 e.g tangly1024
  COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || 'longlife2049', // 管理员用户名、一般是自己 e.g 'tangly1024'
